...
"""
This file is loaded automatically by Fusion at startup
It sets up the Toolkit context and prepares the tk-fusion engine.
"""
...
def display_error(msg):
    print("Shotgun Error | Fusion engine | %s " % msg)


def display_warning(msg):
    print("Shotgun Warning | Fusion engine | %s " % msg)


def display_info(msg):
    print("Shotgun Info | Fusion engine | %s " % msg)
...
def start_toolkit_classic():
    ...
    the tk-fusion engine and environment.
    """
    import sgtk
...
def start_toolkit():
    """
    Import Toolkit and start up a tk-fusion engine based on
    ...
    sgtk.LogManager().initialize_base_file_handler("tk-fusion")
    ...
    if file_to_open:
        ...
        FusionEngine.App.loadProject(file_to_open)
